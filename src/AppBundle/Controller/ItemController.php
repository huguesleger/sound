...
class ItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('back/item/index.html.twig', array(
            'items' => $items,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('back/item/new.html.twig', array(
            'item' => $item,
    ...
    public function showAction(Item $item)
    {
        ...
        return $this->render('back/item/show.html.twig', array(
            'item' => $item,
    ...
    public function editAction(Request $request, Item $item)
    {
        ...
        return $this->render('back/item/edit.html.twig', array(
            'item' => $item,
